# KEY REMINDER Tests should validate behavior, not presence.

# so for environment test consider:

# def test_optional_env_vars_do_not_crash():
#     import spaceklip

# def test_missing_env_var_raises_clear_error():
#     with pytest.raises(SomeError):
#         some_function_that_needs_env()

# def test_env_var_is_read_but_not_required():
#     assert spaceklip.config.get("CRDS_PATH") is not None
