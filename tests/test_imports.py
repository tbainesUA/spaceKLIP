...
"""
Basic import tests for spaceKLIP.

These tests are meant to fail fast if the package
cannot be imported due to missing dependencies,
broken __init__ files, or circular imports.
"""
...
def test_spaceklip_top_level_import():
    """Test that the top-level spaceKLIP package imports."""
    import spaceKLIP  # noqa: F401
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # "spaceKLIP.imaging",
        "spaceKLIP.utils",
        # add more *public-facing* modules here
    ],
)
def test_import_submodules(module_name):
    """
    Test that key submodules import without error.

    This helps catch circular imports and missing
    optional dependencies imported at module level.
    """
